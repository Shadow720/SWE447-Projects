//Read Me
//Implementation of jQuery JavaScript Library 
//http://jquery.com/
//Copyright 2011, John Resig
//http://jquery.org/license
 
//Implementation of Sizzle.js
//http://sizzlejs.com/
...
var jQuery = function( selector, context ) {
	...
	// Check for HTML strings or ID strings
...
jQuery.extend({
	...
	// Full fledged deferred 
	Deferred: function( func ) {
		var deferred = jQuery._Deferred(),
			failDeferred = jQuery._Deferred(),
			promise;
		// Add errorDeferred methodse
...
jQuery.support = (function() {
	...
	if ( !div.addEventListener && div.attachEvent && div.fireEvent ) {
		div.attachEvent( "onclick", function() {
			// Cloning a node shouldn't copy over any bound event handlers 
...
jQuery.extend({
	...
	noData: {
		"embed": true,
		// Ban all objects except for Flash 
...
var Sizzle = function( selector, context, results, seed ) {
	...
	// Reset the position of the chunker 
	do {
		chunker.exec( "" );
...
jQuery.extend({
	...
	ajax: function( url, options ) {
		...
		if ( !s.hasContent ) {
			...
			// Get if ModifiedKey before adding the anti-cache parameter
			ifModifiedKey = s.url;
